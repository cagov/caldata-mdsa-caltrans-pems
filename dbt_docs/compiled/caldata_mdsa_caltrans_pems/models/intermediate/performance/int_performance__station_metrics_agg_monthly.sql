...
monthly_station_level_spatial_temporal_metrics as (
    select
        ...
        60 / nullifzero(monthly_q_value) as monthly_tti,
            ...
            greatest(
                monthly_volume
                * ((length / nullifzero(monthly_speed)) - (length / 35)),
                0
            )
                as delay_35_mph
            ...
            greatest(
                monthly_volume
                * ((length / nullifzero(monthly_speed)) - (length / 40)),
                0
            )
                as delay_40_mph
            ...
            greatest(
                monthly_volume
                * ((length / nullifzero(monthly_speed)) - (length / 45)),
                0
            )
                as delay_45_mph
            ...
            greatest(
                monthly_volume
                * ((length / nullifzero(monthly_speed)) - (length / 50)),
                0
            )
                as delay_50_mph
            ...
            greatest(
                monthly_volume
                * ((length / nullifzero(monthly_speed)) - (length / 55)),
                0
            )
                as delay_55_mph
            ...
            greatest(
                monthly_volume
                * ((length / nullifzero(monthly_speed)) - (length / 60)),
                0
            )
                as delay_60_mph

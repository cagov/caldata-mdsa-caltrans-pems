...
equipment_all_meta as (
    ...
    em.active_date >= cm._valid_from
    and ( em.active_date < cm._valid_to or cm._valid_to is null)
...
equipment_with_samples as (
    ...
    left join ANALYTICS_PRD.diagnostics.int_diagnostics__samples_per_detector as source
        on
